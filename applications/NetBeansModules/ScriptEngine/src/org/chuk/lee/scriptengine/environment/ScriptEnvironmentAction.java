...
/**
 * Action which shows ScriptEnvironment component.
 */
public class ScriptEnvironmentAction extends AbstractAction {
    
    public ScriptEnvironmentAction() {
        super(NbBundle.getMessage(ScriptEnvironmentAction.class, "CTL_ScriptEnvironmentAction"));
        putValue(SMALL_ICON, new ImageIcon(Utilities.loadImage(ScriptEnvironmentTopComponent.ICON_PATH, true)));
    }
    
    public void actionPerformed(ActionEvent evt) {
        TopComponent win = ScriptEnvironmentTopComponent.findInstance();
        win.open();
        win.requestActive();
    }
